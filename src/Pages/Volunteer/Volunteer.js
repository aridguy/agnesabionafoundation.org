...
const Volunteer = () => {
  ...
  const goHome = () => navigateToVolunteer("/");
  useEffect(() => {
    AOS.init();
  }, []);
      ...
      <div className="formBg">
        <div className="container">
                ...
                <div className="row">
                  <div className="col-md-12 text-center">
                    <h4 className="text-white">
                      We need some informations for us to verify you as a
                      volunteer with us.
                    </h4>
                  </div>
                </div>
                <form onSubmit={handleSubmit}>
                  ...
                  <p>
                    <input
                      type="text"
                      name="number"
                      placeholder="phone number (home/Mobile)"
                      className="form-control"
                      id="number"
                    />
                    <ValidationError
                  ...
                  <p>
                    <input
                      type="text"
                      name="email"
                      placeholder="email address (home/Mobile)"
                      className="form-control"
                      id="email"
                    />
                    <ValidationError
                  ...
                  <h4 className="text-white">
                    Ifyou are involved with us as a volunteer and an emergency
                    arises, whom should we contact?
                  </h4>
                  <p>
                    <input
                      type="text"
                  ...
                  <h4 className="text-white">
                    Equal<span className="opportunityEqu">Opportunities</span>
                  </h4>
                  ...
                  <h4 className="text-white">
                    Disclosure
                    <span className="opportunityEqu">ofCriminalBackground</span>
                  </h4>
                  <span className="text-white">
                  ...
                  <p className="mt-2">
                    <input
                      ...
                      placeholder="Have you ever been convicted in last 5 years?"
                      className="form-control"
                      id="vforms"
                    />
                    <ValidationError
                  ...
                  <h4 className="text-white">
                    Your{" "}
                    <span className="opportunityEqu">Skills and interests</span>
                  </h4>
                  <span className="text-white">
                    Help Bristol’s Homelessis committed to equal opportunities
                    and all volunteer recruitment decisions will be based on
                  ...
                  <p className="mt-2">
                    <input
                      type="text"
                      name="experience"
                      placeholder="have a voluntary work experience? if yes please explain!"
                      className="form-control"
                      id="vforms"
                    />
                    <ValidationError
                  ...
                  <h4 className="text-white">
                    Your <span className="opportunityEqu">Documents</span>
                  </h4>
          ...
          <div className="row mt-5">
            ...
            <div className="col-md-4">
              <button className="btn btn-info go-home-btn" onClick={goHome}>Home</button>
            </div>
            <div className="col-md-4">
