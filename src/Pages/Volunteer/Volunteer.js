                    ...
                    <div className="row">
                        ...
                        <div className="col-md-6">
                            <div className="formInnerPlace p-5">
                                ...
                                <form>
                                    <p><input type="text" name="name" placeholder="full name" className="form-control" id="vforms" /></p>
                                    <p><input type="text" name="address" placeholder="address" className="form-control" id="vforms" /></p>
                                    <p><input type="text" name="country" placeholder="country" className="form-control" id="vforms" /></p>
                                    <p><input type="text" name="number" placeholder="phone number (home/Mobile)" className="form-control" id="vforms" /></p>
                                    <p><input type="text" name="email" placeholder="email address (home/Mobile)" className="form-control" id="vforms" /></p>
                                    <p><input type="text" name="country" placeholder="country" className="form-control" id="vforms" /></p>
                                    <p><input type="date" name="date of birth" placeholder="date of birth" className="form-control" id="vforms" /></p>

                                    <h4 className="text-white">Ifyou are involved with us as a volunteer and an emergency arises, whom should we contact?</h4>
                                    <p><input type="text" name="date of birth" placeholder="name of NOK" className="form-control" id="vforms" /></p>
                                    <p><input type="text" name="relationship NOK" placeholder="relationship to NOK" className="form-control" id="vforms" /></p>
                                    <p><input type="text" name="number next of kin" placeholder="phone number  (home/Mobile)" className="form-control" id="vforms" /></p>
                                    ...
                                    <p className="mt-2"><input type="text" name="criminal records" placeholder="Have you ever been convicted in last 5 years?" className="form-control" id="vforms" /></p>
                                    ...
                                    <p className="mt-2"><input type="text" name="experience" placeholder="have a voluntary work experience? if yes please explain!" className="form-control" id="vforms" /></p>
                                    ...
                                    <p className="mt-2"><input title="upload CV" type="file" name="upload cv" placeholder="have a voluntary work experience? if yes please explain!" className="form-control" id="vforms" /></p>
                                    <i className="text-white">passport photograph</i>
                                    <p className="mt-2"><input title="upload CV" type="file" name="passport" placeholder="have a voluntary work experience? if yes please explain!" className="form-control" id="vforms" /></p>
                                    ...
                                    <p className="mt-2 text-white"><input title="upload CV" type="checkbox" name="passport" placeholder="have a voluntary work experience? if yes please explain!" id="vforms" /> I agress to agnesabionafoundation terms and conditions</p>
